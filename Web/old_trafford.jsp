...
<link rel="stylesheet" href="css/jquery.jscrollpane1.css" type="text/css" media="all" />
...
<body>
<div id="main" class="main"> <img src="images/album/1.jpg" alt="" class="preview" style="display:none;"/>
  <section class="overlay"></section>
  <header id="header">
    <h3>曼联</h3>
    <h6>老特拉福德球场 <a href="" target="_blank"></a></h6>
  </header>
...
<script type="text/javascript" src="js/cufon.js"></script> 
<script type="text/javascript" src="js/Quicksand_Book_400.font.js"></script> 
<script type="text/javascript" src="js/functions.js"></script><!-- Free template distributed by http://freehtml5templates.com -->
</body>
</html>