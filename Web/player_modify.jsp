...
<body>
<div class="container" >
  <form method="post" action="servlet/PlayerManage?action=<%=CONSTANT.ACTIONPARAM.MODIFY %>&redirect=PlayerManage?action=<%=CONSTANT.ACTIONPARAM.SHOWALL %>%26redirect=<%=path %>/player_mng.jsp"
